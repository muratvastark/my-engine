...
exports.run = async (Moderation, message, args) => {
    ...
    message.channel.send(new MessageEmbed().setColor("RANDOM").setDescription(`${Member.toString()} kişisi başarıyla \`erkek\` olarak kaydedildi.`));
    ...
    global.addName(Member.id, Member.displayName, `<@&${Register.ManRoles[0]}>`);
};

exports.conf = {
    commands: ["e", "erkek", "bay"],
    enabled: true,
    usage: "e [Üye]"
};
